    ...
    <div class="container py-3">
       ...
       <div class="card border-0 shadow-lg mt-2">
          ...
          <div class="mb-3">
            ...
            <input type="text" name="mobile" id="mobile" placeholder="Enter your mobile" class="form-control @error('mobile') is-invalid @enderror" value="{{ old('mobile')}}">
            @error('mobile')
                <p class="invalid-feedback">{{$message}}</p>
            @enderror
          </div>
        ...
        <div class="mb-3">
            ...
            <input type="password" name="pasword" id="password" placeholder="Enter your password" class="form-control @error('password') is-invalid @enderror" value="{{ old('password')}}">
            @error('password')
                <p class="invalid-feedback">{{$message}}</p>
            @enderror
          </div>
